...
12 | Change the login slug |	Change the login slug. To verify this, enter the domain name with /login, the page should redirect to 404 page and If it opens the login page then your site not secure.
...
19 | Test for Responsiveness: | "Ensure that your website is responsive and mobile ready by running Google’s Mobile Friendly Test. URL: [Lighthouse Overview](https://developer.chrome.com/docs/lighthouse/overview/)"
