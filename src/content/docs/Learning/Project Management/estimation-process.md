...
:::tip
SPOCs can initiate to set up a working session to make the estimates if there are too many uncertainties or there is a need for extra support from Management Team Members (CEO/ Account Manager/ COO/ Tech Lead/ PMO lead etc)
:::
...
:::note
It's very difficult (if not impossible) at the end of phase 1 to give the client an estimate above the "high" - so factor that into your estimate process.
:::
