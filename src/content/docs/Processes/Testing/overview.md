...
![Test Case - Example](../../../../assets/testcase.png)
:::
...
:::success[LAMBDATEST - Example]
![LAMBDATEST](../../../../assets/LAMBDA.png)
:::
...
5. **Missing (or SLOW to load) Content**
...
6. **Email and Phone Number Issues**
**On Desktop browsers**
...
7. **Form Issues**
**Note: The PM/Dev resources should be documenting all form requirements (field expectations, alert messages, etc.) clearly up-front (within the SOW/ticket/task) to ensure that the form is developed appropriately, as well as tested according to the expected behaviour for each field/the entire form user journey.*
...
8. **Plugin and API Behavior Issues**
...
9. **Content Sharing/Posting Issues**
...
10. **URL and/or Page Naming Issues**
...
11. **Behavior State Issues**
- Ensure that the BEHAVIOR STATES for the following items work/behave as expected/what's been directed on each page (across all devices/browsers):
a. Menu Items
b. Sub-menu Items
c. Buttons
d. Links
e. Images *(If applicable. Note: Often images will have hover-over and/or active state)*

-BEHAVIOR STATES for the above items are typically as follows:
a. Hover-over State
b. Selected/Active State
c. Static/Disabled (Inactive link.)
...
16. **UI (User Interface) Testing:**
a. **Design Symmetry and Consistency Issues**
...
i. Margins
ii. Spacing	
iii. Alignments (in relation to text/images/links/buttons)
iv. Colors
v. Area blocks
vi. Sizes used (for all elements on the page)
