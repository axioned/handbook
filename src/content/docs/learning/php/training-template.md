...
| | <mark style={{display: 'block', padding: 'inherit', background: '#ffeb3b52' }}>**1st Task** <br /> ( Assign certain tasks to test if fundamentals are clearly understood or not )</mark> | 4 |
...
| | <mark style={{display: 'block', padding: 'inherit', background: '#ffeb3b52' }}>**2nd Task** <br /> ( Assign certain tasks to test if Array and String functions are clearly understood or not )</mark> | 4 |
...
| | <mark style={{display: 'block', padding: 'inherit', background: '#ffeb3b52' }}>**3rd Task** <br /> ( Assign certain tasks on PHP functions )</mark> | 8 |
...
| | <mark style={{display: 'block', padding: 'inherit', background: '#ffeb3b52' }}>**1st Test** <br /> ( Assign a complex functionality test on all the topics above )</mark> | 12 |
...
| | <mark style={{display: 'block', padding: 'inherit', background: '#ffeb3b52' }}>**Final Test** <br /> Final test in PHP to check if trainee can proceed in PHP or not</mark> | 8 |
